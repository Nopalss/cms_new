            ...
            <div class="mrl-card">
                ...
                <div class="mrl-body">
                    ...
                    <div class="mrl-actions d-flex justify-content-end mt-3">
                        ...
                        <a href="${HOST_URL}pages/service_report/update.php?id=${row.srv_id}" class="btn btn-sm btn-light-warning btn-icon mr-2">
                            <i class="flaticon-edit"></i>
                        </a>
                        <a onclick="confirmDeleteTemplate('${row.srv_key}', 'controllers/report/service/delete.php')" class="btn btn-sm btn-light-danger btn-icon">
