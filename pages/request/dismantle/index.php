...
$_SESSION['table'] = 'request dismantle';
    ...
    <div class="d-flex flex-column-fluid">
        <div class="container">
            ...
            <div class="registrasi-page-header">
                <div>
                    <h1>Request Dismantle</h1>
                    <p>Kelola data request dismantle pelanggan.</p>
                </div>
                <div class="header-actions">
                    <!-- <a href="<?= BASE_URL ?>pages/request/dismantle/export_excel.php" class="btn btn-outline-success font-weight-bolder">
