...
try {
    ...
    $sql = "SELECT registrasi_id , name, perumahan FROM register WHERE is_verified = 'Unverified'";
...
<div class="ikr-page">
    <div class="container">
        ...
        <div class="ikr-header d-flex align-items-start justify-content-between flex-wrap gap-2">
            <div>
                <h1 class="ikr-header__title">Request IKR</h1>
        ...
        <div class="ikr-steps">
            ...
            <div class="ikr-step active">
                ...
                <span class="ikr-step__label">Request IKR</span>
            </div>
            <div class="ikr-step__line"></div>
            <div class="ikr-step">
        ...
        <!-- Main Form -->
        <form method="post" action="<?= BASE_URL ?>controllers/request/ikr/create.php">
            <div class="row">
                        ...
                        <div class="ikr-card__body">
                            ...
                            <div class="form-group">
                                ...
                                <?php if (empty($row['registrasi_id'])): ?>
                                    <select class="ikr-field selectpicker w-100" id="registrasi_id" name="registrasi_id" data-size="7" data-live-search="true" title="Pilih ID Registrasi...">
                                        <?php if (empty($ids)): ?>
                                            <option value="" disabled>Tidak ada data pending</option>
                                        <?php else: ?>
                                            <?php foreach ($ids as $i): ?>
                                                <option value="<?= $i['registrasi_id'] ?>"><?= $i['registrasi_id'] . " - " . $i['name'] . " - " . $i['perumahan'] ?></option>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
                                    </select>
                                <?php else: ?>
                                    <input type="text" class="ikr-field" disabled value="<?= $row['registrasi_id'] ?>">
                                    <input type="hidden" name="registrasi_id" value="<?= $row['registrasi_id'] ?>">
                                <?php endif; ?>
                            </div>

                            <!-- Nama & No HP side by side on md+ -->
                            <div class="row">
                                <div class="col-sm-7">
                                    <div class="form-group">
                                        <label class="ikr-label" for="name">Nama Pelanggan</label>
                                        <input id="name" type="text" class="ikr-field" name="name" value="<?= $row['name'] ?>" placeholder="Nama lengkap" required>
                                    </div>
                                </div>
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        <label class="ikr-label" for="phone">No HP</label>
                                        <input id="phone" type="tel" class="ikr-field" name="phone" value="<?= $row['phone'] ?>" placeholder="08xx-xxxx-xxxx"
                            ...
                            <div class="form-group">
                                ...
                                <select class="ikr-field selectpicker w-100" id="paket_internet" name="paket_internet" data-size="7">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="ikr-field ikr-field--readonly" id="date" disabled value="<?= $row['date'] ?>">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="ikr-label">Jam Diinginkan</label>
                                        <input type="text" class="ikr-field ikr-field--readonly" id="time" readonly value="<?= $row['time'] ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group mb-0">
                                ...
                                <textarea class="ikr-field" id="location" name="location" rows="3" placeholder="Jl. ..."><?= $row['location'] ?></textarea>
                            </div>
                ...
                <div class="col-lg-6 mb-4">
                    <div class="ikr-card d-flex flex-column">
                        <div class="ikr-card__head">
                            ...
                            <div>
                                <p class="ikr-card__title">Ajukan Permintaan IKR</p>
                                <p class="ikr-card__sub">Isi detail jadwal pemasangan yang sudah dikonfirmasi</p>
                            </div>
                        </div>
                        ...
                        <div class="ikr-card__body flex-grow-1">
                            ...
                            <div class="form-group">
                                ...
                                <span class="ikr-id-display"><?= $rikr_id ?></span>
                                <input type="hidden" name="rikr_id" value="<?= $rikr_id ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="netpay-group">
                                    <select id="netpay_kode" name="netpay_kode" class="ikr-field selectpicker" data-size="7">
                                    ...
                                    <input type="text" id="netpay_id_text" class="ikr-field netpay-text" placeholder="ID akan terisi otomatis" readonly>
                                    <input type="hidden" id="netpay_id" name="netpay_id">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="ikr-field" id="registrasi_id2" value="<?= $row['registrasi_id'] ?>" disabled>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" id="date_pemasangan" class="ikr-field" name="date_pemasangan" min="<?= date('Y-m-d') ?>" value="<?= $row['date'] ?>">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="ikr-label" for="time_pemasangan">Jam Pemasangan</label>
                                        <input type="text" id="time_pemasangan" class="ikr-field" name="time_pemasangan" value="<?= $row['time'] ?>" placeholder="HH:MM">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group mb-0">
                                ...
                                <textarea class="ikr-field" id="catatan" name="catatan" rows="4" placeholder="Informasi tambahan untuk teknisi..."></textarea>
                            </div>

                        </div>

                        <div class="ikr-card__foot">
                            <a href="<?= BASE_URL ?>pages/schedule/" class="btn-ikr-cancel">
                                <i class="fas fa-times" style="font-size:.75rem"></i> Batal
                            </a>
                            <button type="submit" name="submit" class="btn-ikr-primary">
                                <i class="fas fa-paper-plane" style="font-size:.8rem; margin-right:.35rem"></i>
                                Simpan Request
                            </button>
                        </div>
                    </div>
...
<script>
    ...
    const timeInput = document.getElementById('time_pemasangan');
