...
<div class="content">
    <div class="container px-3 pb-5">
        ...
        <form id="formUpdate" method="post"
            action="<?= BASE_URL ?>controllers/report/service/update.php"
            novalidate>

            <input type="hidden" name="srv_key" value="<?= htmlspecialchars($customer['srv_key']) ?>">
            <input type="hidden" name="srv_id" value="<?= htmlspecialchars($customer['srv_id'])  ?>">

            <div id="captureForm">

                <!-- HERO -->
                <div class="card sr-card shadow-sm mt-3 mb-3">
                    <span class="sr-stripe" style="background:linear-gradient(90deg,#6366F1,#818CF8)"></span>
                    <div class="card-body py-3">
                        <div class="d-flex align-items-center justify-content-between mb-2">
                            <span class="badge px-3 py-2"
                                style="background:#EEF2FF;color:#3730A3;border-radius:20px;font-size:10px;font-weight:800;letter-spacing:.5px">
                                ✏️ UPDATE SERVICE REPORT
                            </span>
                            <small class="text-muted font-weight-bold"><?= htmlspecialchars($customer['srv_id']) ?></small>
                        </div>
                ...
                <div class="card sr-card shadow-sm mb-3">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <textarea class="form-control sr-control validate-field" name="problem" rows="3"
                                placeholder="Jelaskan masalah yang ditemukan..."><?= htmlspecialchars($customer['problem']) ?></textarea>
                            <div class="invalid-feedback">⚠️ Problem wajib diisi</div>
                        </div>
                        <div class="form-group">
                            <label class="sr-label">Action <span class="text-danger">*</span></label>
                            <textarea class="form-control sr-control validate-field" name="action" rows="3"
                                placeholder="Tindakan yang sudah dilakukan..."><?= htmlspecialchars($customer['action']) ?></textarea>
                            <div class="invalid-feedback">⚠️ Action wajib diisi</div>
                        </div>
                        <div class="form-group mb-0">
                            <label class="sr-label">Part <span class="text-danger">*</span></label>
                            <textarea class="form-control sr-control validate-field" name="part" rows="2"
                                placeholder="Part yang digunakan (tulis '-' jika tidak ada)"><?= htmlspecialchars($customer['part']) ?></textarea>
                    ...
                    <div class="card-body">
                        <div class="form-row mb-3">
                            <div class="col-6">
                                ...
                                <input class="form-control sr-control validate-field" name="ont_bef"
                                    placeholder="SN ONT lama"
                                    value="<?= htmlspecialchars($customer['ont_bef']) ?>">
                            ...
                            <div class="col-6">
                                ...
                                <input class="form-control sr-control" name="ont_aft"
                                    placeholder="SN ONT baru"
                                    value="<?= htmlspecialchars($customer['ont_aft'] ?? '') ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="col-6">
                                ...
                                <input class="form-control sr-control validate-field" name="red_bef"
                                    placeholder="-xx dBm"
                                    value="<?= htmlspecialchars($customer['red_bef']) ?>">
                            ...
                            <div class="col-6">
                                ...
                                <input class="form-control sr-control validate-field" name="red_aft"
                                    placeholder="-xx dBm"
                                    value="<?= htmlspecialchars($customer['red_aft']) ?>">
                ...
                <div class="card sr-card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        <textarea class="form-control sr-control validate-field" name="keterangan" rows="4"
                            placeholder="Kondisi akhir, catatan tambahan, rekomendasi..."><?= htmlspecialchars($customer['keterangan']) ?></textarea>
