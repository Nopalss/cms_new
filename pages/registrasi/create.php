    ...
    <div class="d-flex flex-column-fluid">
        <div class="container">
            ...
            <div class="create-page-header">
                ...
                <p>Tambah data calon pelanggan internet baru secara langsung.</p>
            </div>
            <!--end::Page Header-->
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    ...
                    <div class="card form-card">
                        <form method="post" id="registrasi-form" action="<?= BASE_URL ?>controllers/registrasi/create.php">
                                    ...
                                    <div class="col-lg-6 pr-lg-8 border-right-lg">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="field-icon">
                                                ...
                                                <input type="tel" class="form-control" name="phone" placeholder="Contoh: 081234567890" required>
                                            </div>
                                        </div>
                                            ...
                                            <label>Perumahan</label>
                                             <select class="form-control selectpicker" id="perumahan" name="perumahan" data-container="body" data-size="7" data-live-search="true" required>
                                                ...
                                                <?php foreach ($perumahan as $p): ?>
                                                    <option value="<?= htmlspecialchars($p['perumahan']) ?>"><?= htmlspecialchars($p['perumahan']) ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="location" rows="4" placeholder="Jalan, nomor rumah, RT/RW, kelurahan, kecamatan..." required></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 pl-lg-8 mt-8 mt-lg-0">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="field-icon">
                                                ...
                                                <input type="date" class="form-control" name="date" min="<?= date('Y-m-d', strtotime('+1 day')) ?>" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="field-icon">
                                                ...
                                                <input type="text" class="form-control" name="time" id="time-schedule" placeholder="09:00" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
