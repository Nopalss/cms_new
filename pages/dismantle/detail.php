...
try {
    ...
    $sql = "
        ...
        JOIN dismantle_reports dr ON drp.dismantle_id = dr.dismantle_id
        LEFT JOIN technician t ON drp.tech_id = t.tech_id
        WHERE drp.dismantle_id = :dismantle_id
    ";
...
<style>
    /* ============================================================
   DISMANTLE REPORT DETAIL — Custom styles (Bootstrap 4 base)
   ============================================================ */
...
<div class="d-flex flex-column flex-row-fluid wrapper pt-20" id="kt_wrapper">
    ...
    <div class="content d-flex flex-column-fluid">
        <div class="container py-6">
            ...
            <!-- ── Page Header ── -->
            <div class="mb-6">
                <h1 class="sr-page-title">Dismantle Report Detail</h1>
                <span class="sr-badge-id">
                    <i class="fas fa-hashtag mr-1" style="font-size:10px;"></i>
                    <?= htmlspecialchars($row['dismantle_id'] ?? '') ?>
                </span>
            </div>
                ...
                <div class="col-md-6 mb-5">
                    <div class="sr-card">
                        <div class="sr-card-head">
                            ...
                            <span>Dismantle Information</span>
                        </div>

                        <div class="sr-row">
                            <div class="sr-label"><i class="fas fa-id-card text-secondary"></i> Netpay ID</div>
                            <div class="sr-value"><?= htmlspecialchars($row['netpay_id'] ?? '-') ?></div>
                        </div>
                        <div class="sr-row">
                            <div class="sr-label"><i class="fas fa-calendar text-primary"></i> Tanggal</div>
                            <div class="sr-value"><?= htmlspecialchars($row['tanggal'] ?? '-') ?></div>
                        </div>
                        <div class="sr-row">
                            <div class="sr-label"><i class="fas fa-clock text-secondary"></i> Jam Input</div>
                            <div class="sr-value"><?= htmlspecialchars($row['jam'] ?? '-') ?></div>
                        </div>
                        <div class="sr-row">
                            <div class="sr-label"><i class="fas fa-question-circle text-warning"></i> Alasan</div>
                            <div class="sr-value"><?= nl2br(htmlspecialchars($row['alasan'] ?? '-')) ?></div>
                        </div>
                        <div class="sr-row">
                        ...
                        <div class="sr-row">
                            <div class="sr-label"><i class="fas fa-minus-circle text-danger"></i> Part Removed</div>
                            <div class="sr-value"><?= htmlspecialchars($row['part_removed'] ?? '-') ?></div>
                        </div>
                        <div class="sr-row">
                            <div class="sr-label"><i class="fas fa-clipboard-check text-info"></i> Kondisi Perangkat</div>
                            <div class="sr-value"><?= htmlspecialchars($row['kondisi_perangkat'] ?? '-') ?></div>
                        </div>
                        <div class="sr-row">
            ...
            <div class="d-flex justify-content-end mt-2">
                <a href="<?= BASE_URL ?>pages/dismantle/" class="btn-back">
