    ...
    if ($_SESSION['role'] == 'teknisi') {
        $sumStmt = $pdo->prepare(
            "SELECT COUNT(DISTINCT dr.dismantle_id) AS total
             FROM dismantle_reports dr
             LEFT JOIN dismantle_report_pic drp ON dr.dismantle_id = drp.dismantle_id
             WHERE DATE(dr.created_at) = :today AND FIND_IN_SET(:tech_id, drp.tech_id)"
        );
        $sumStmt->execute([':today' => $today, ':tech_id' => $_SESSION['id_karyawan']]);
    } else {
    ...
    <div class="d-flex flex-column-fluid">
        <div class="container">
            ...
            <div class="registrasi-page-header">
                <div>
                    <h1>Dismantle Reports</h1>
                    <p>Kelola data laporan pembongkaran/dismantle pelanggan.</p>
                </div>
                <div class="header-actions">
                    <!-- <a href="<?= BASE_URL ?>pages/dismantle/export_excel.php" class="btn btn-outline-success font-weight-bolder">
            ...
            <div class="kpi-grid">
                <div class="kpi-card kpi-total" id="kpi-card-total">
                    ...
                    <div class="kpi-text">
                        <div class="kpi-label">Total Dismantle</div>
            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Data Dismantle Reports</h3>
                    </div>
                </div>
                <div class="card-body">
                    <!--begin::Search Form-->
